...
def test_start_new_game():
    ...
    assert len(test_hat_bot.used_words) == 0
...
def test_check_word():
    ...
    assert len(test_hat_bot.words) == 1
    assert len(test_hat_bot.used_words) == 1
    ...
    assert len(test_hat_bot.words) == 0
    assert len(test_hat_bot.used_words) == 2
